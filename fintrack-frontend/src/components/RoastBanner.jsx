  ...
  return (
    ...
    >
      <div style={{ display: 'flex', alignItems: 'flex-start', gap: '10px', flex: '1 1 240px' }}>
        ...
        >
          <Coffee size={17} style={{ color: '#DC2626' }} />
        </div>

        <div style={{ flex: 1, minWidth: 0 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '6px', marginBottom: '2px' }}>
            <span style={{ fontSize: '0.7rem', fontWeight: 800, color: '#DC2626', letterSpacing: '0.06em' }}>
              AI ROAST MODE
            </span>
            <span style={{ fontSize: '0.68rem', color: '#6B7280' }}>• LIVE INSIGHT</span>
          </div>
          <p style={{ fontSize: '0.835rem', color: '#1F2937', margin: 0, fontWeight: 500, lineHeight: 1.4, wordBreak: 'break-word' }}>
            {currentRoast}
          </p>
        </div>
      </div>

      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'flex-end', gap: '6px', marginLeft: 'auto' }}>
        <button
          type="button"
